...
# Use data from https://dumps.wikimedia.org/
# First, downlaod the data

#create model and train. Save the weights. In my case, the saved weights is a file called `LSTM-weights-wiki1MB.hdf5`
# Eample on How to use
# python textgen.py gen "data/wiki1MB.txt" --weightsfile="data/LSTM-weights-wiki1MB.hdf5" -n 10
